...
| File | Description |
|---|---|
| [`demo.png`](out/demo.png) | Screenshot / demo of the plugin workflow |
| [`portfolio_2026Q2.xlsx`](out/portfolio_2026Q2.xlsx) | Example Excel workbook from `china-model-builder` (portfolio DCF & comps) |
| [`portfolio_roadshow_2026Q2.pptx`](out/portfolio_roadshow_2026Q2.pptx) | Example slide deck from `china-market-researcher` (portfolio roadshow) |
